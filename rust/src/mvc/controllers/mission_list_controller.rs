...
impl MissionModel {
    ...
    fn update_mission(&self, index: usize, mission: mvc::MissionStruct) {
    ...
    fn push_mission(&self, mission: mvc::MissionStruct) {
...
mod tests {
    ...
    fn test_add_mission() {
        ...
        controller.create_mission(mission3().into());
