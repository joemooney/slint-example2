...
impl TaskModel {
    ...
    fn push_task(&self, task: mvc::TaskStruct) {
...
mod tests {
    ...
    fn test_controller() -> TaskListController {
        TaskListController::new(mvc::MockTaskRepository::new(vec![
            mvc::TaskStruct { title: "Item 1".into(), due_date: 1, done: true, priority: "low".into() },
            mvc::TaskStruct { title: "Item 2".into(), due_date: 1, done: false, priority: "low".into() },
        ]))
    }
    ...
    fn test_tasks() {
        ...
        assert_eq!(
            ...
            Some(mvc::TaskStruct { title: "Item 1".into(), due_date: 1, done: true, priority: "low".into() },)
        );
        assert_eq!(
            task_model.row_data(1),
            Some(mvc::TaskStruct { title: "Item 2".into(), due_date: 1, done: false, priority: "low".into() },)
        );
    }
    ...
    fn test_add_task() {
        ...
        assert_eq!(
            ...
            Some(mvc::TaskStruct { title: "Item 3".into(), due_date: 3, done: false, priority: "low".into() },)
        );
    }
}
