...
pub struct MockTaskRepository {
    tasks: Rc<RefCell<Vec<mvc::TaskStruct>>>,
}

impl MockTaskRepository {
    pub fn new(tasks: Vec<mvc::TaskStruct>) -> Self {
...
impl traits::TaskRepository for MockTaskRepository {
    ...
    fn get_task(&self, index: usize) -> Option<mvc::TaskStruct> {
    ...
    fn push_task(&self, task: mvc::TaskStruct) -> bool {
